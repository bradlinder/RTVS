...
echo "====================================================================="
echo " Radio & TV Segmenter v2.1.6 - Automated 1-Click Build (Linux)"
echo "====================================================================="
echo ""
...
VERSION=$(python3 -c "from prs_shared import PROJECT_VERSION; print(PROJECT_VERSION)" 2>/dev/null || echo "2.1.6")
